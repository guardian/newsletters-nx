...
Welcome! This wizard will shortly guide you through the process of creating a newsletter. Here’s what you need to know:
 ...
 - The wizard saves automatically and if you wish to exit the wizard, you can do so. The newsletter draft will be available for you to edit in future under the ["Drafts" section](/drafts)`,
	label: 'Welcome',
	buttons: {
		next: {
			buttonType: 'NEXT',
