@feature-create-newsletter-wizard
Feature: Create a newsletter in the redesigned wizard
	New newsletters can be created via a series of guided steps in the 'stand'
	design system
	...
	Rule: Editors can complete steps in the wizard
	...
	Rule: Only article-based newsletters can have rendering options
	...
	Rule: Some fields are mandatory
